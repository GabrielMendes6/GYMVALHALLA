...
<svg xmlns="http://www.w3.org/2000/svg" class="hidden">    
    ...
    <section id="mainSect">
        <div id="justFy">
            ...
            <div id="optionAccount">
                <div class="boxOptionsAccount" id="infoDiv">
                    <a href="../identity/person.php">
                        <div class="imgAvatar">
                            <div class="imgCirc">
                                <span>
                                <svg class="icon-inline">
                        ...
                        <div class="InfoPerfil">
                            ...
                            <p>são as informações que você preenche para usar sua conta</p>
                        </div>
                ...
                <div class="boxOptionsAccount" id="cartDiv">
                    <a href="../cart/mycart.php">
                        <div class="imgAvatar">
                            <div class="imgCirc">
                                <span>
                                <svg class="icon-inline">
                        ...
                        <div class="InfoPerfil">
                            <span>Carrinho</span>
                            <p>itens salvos em seu carrinho</p>
                        </div>
                        <span class="ChevronIcon">
                            <svg class="icon-inline">
                                <use xlink:href="#chevron"></use>
                ...
                <div class="boxOptionsAccount" id="securityDiv">
                    <a href="">
                        <div class="imgAvatar">
                            <div class="imgCirc">
                                <span>
                        ...
                        <div class="InfoPerfil">
                            <span>Segurança</span>
                            <p>configurar ou alterar dados seguros</p>
                        </div>
                        <span class="ChevronIcon">
                            <svg class="icon-inline">
                                <use xlink:href="#chevron"></use>
                ...
                <div class="boxOptionsAccount" id="cardsDiv">
                    <a href="">
                        <div class="imgAvatar">
                            <div class="imgCirc">
                                <span>
                        ...
                        <div class="InfoPerfil">
                            <span>Cartões</span>
                            <p>adicionar ou remover os cartões de sua conta</p>
                        </div>
                        <span class="ChevronIcon">
                            <svg class="icon-inline">
                                <use xlink:href="#chevron"></use>
                ...
                <div class="boxOptionsAccount" id="AddressDiv">
                    <a href="">
                        <div class="imgAvatar">
                            <div class="imgCirc">
                                <span>
                ...
                <div class="boxOptionsAccount" id="LogOutDiv">
                    <a href="../src/logout.php">
                        ...
                        <div class="InfoPerfil">
                            ...
                            <p>clique aqui para sair de sua conta</p>
                        </div>
                        <span class="ChevronIcon">
                            <svg class="icon-inline">
                                <use xlink:href="#chevron"></use>
