<?php
    ...
    $emailVerify = $_SESSION["tmp_email"];
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <link rel="stylesheet" href="./css/emailEnv.css">

    <script src="../src/main.js" defer></script>
    <script src="./js/emailEnv.js" defer></script>
    ...
    <section id="home-sect">
        ...
        <main>
            <div id="justCont" class="just">
                <div id="boxEmail" class="just">
                    <div class="svg-img-Email">
                        <svg class="icon-inline">
                            <use xlink:href="#email"></use>
                        </svg>
                    </div>
                    <div id="textEmail">
                        <h2><?php echo "Um email Foi Enviado para Seu E-mail." ?></h2>
