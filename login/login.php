<?php
    ...
    if($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        $controller->login($_POST["email"], $_POST["pass"]);
    } 
?>
<!DOCTYPE html>
<html lang="pt-BR">
    ...
    <section id="home-sect">
        ...
        <main>
            <div id="justCont">
                ...
                <form method="POST" action="login.php" id="FormDiv">
                    <div id="divEmail">
                        <label for="email" class="labelLogin">E-mail</label>
                        <input type="email" class="inputLogin" name="email" id="email" placeholder="ex: seuemail@email.com">
                    </div>

                    <div id="divPass">
                        <label for="email" class="labelLogin">Senha</label>
                        <div id="borderPass">
                        ...
                        <span id="forgetPass" class="fontSmall">
                            <a href="">
                                esqueceu a senha?
                            </a>
                        </span>
                    ...
                    <div id="envForm">
                        <input type="submit" id="eFormBtn" value="Iniciar Sessão">
                        <span class="fontSmall">
                            Não possui conta? <a href="../cadastro/cadastro.php"> Criar uma conta</a>
                        </span>
                    </div>
                </form>
            </div>
