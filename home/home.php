...
<svg xmlns="http://www.w3.org/2000/svg" class="hidden">    
    ...
    <section id="home-sect">
        <div id="header-top" class="bg-Red center">
            <span>FRETE GRATIS PARA TODO O BRASIL!</span>
        </div>
        <div id="divCarOpac" class="hidden">
            <div id="ColorDiv">

            </div>
            <div id="Divcart" >  
                <div class="divClose" id="btnclose">
                    <h3>cart</h3>
                    <svg class="icon-inline svg-icon-text"><use xlink:href="#times"></use></svg>
                </div> 
                <div id="prodcart">
                    <div class="objCar1">
                        <img src="../img/Tshirts/TrueClub-Front.webp" alt="">
                    </div>
                    <div class="objCar2">
                        <span>CAMISETA LONG OVERSIZED - TRUE CLUB</span>
                        <p>R$ 149,00</p>
                    </div>
                    <div class="objCar3">
                        <div class="posObjBtn">
                ...
                <div id="prodcart">
                    <div class="objCar1">
                        <img src="../img/Tshirts/CompanyOffWhite-Front.webp" alt="">
                    </div>
                    <div class="objCar2">
                        <span>CAMISETA LONG OVERSIZED - COMPANY OFF WHITE</span>
                        <p>R$ 149,00</p>
                    </div>
                    <div class="objCar3">
                        <div class="posObjBtn">
                ...
                <div id="Endcart">
                    <div id="cardTotal-Container">
                        <div id="totalDiv">
                            <h2>Total:</h2>
                        </div>
                        <div id="valorDiv">
                            <span>R$ 298,00</span>
                            <p>Ou até 12x de R$ 24,83 sem juros</p>
                        </div>
                    </div>
                    <div id="CardTotal-ButtonDiv">
        ...
        <div id="contMenuMob" class="hidden">
            
            <div id="mobile-menu">
                <div id="searchMo">
                    <form action="">
                        <div id="formSearch">
                            <input type="text" placeholder="buscar" class="js-input-search">
                            <button id="btnSearch-Mobile" type="button">
                                <svg class="js-open-quickshop-icon icon-inline ml-1">
                ...
                <nav id="menu-hamburguer">
                    <ul id="menuH-mobile">
                        <li class="mobileLi-menu">
                            <a href="" class="linkMenu-Mobile">Inicio</a>
                        </li>
                        <li class="mobileLi-menu">
                            <a href="?mpage=1" class="linkMenu-Mobile">
                                Produtos
                        ...
                        <li class="mobileLi-menu"><a href="" class="linkMenu-Mobile">Outlet</a></li>
                    </ul>
                </nav>
            </div>
            <span id="closeMob">
            ...
            <div id="div-logo" class="center">
                <a href="../home/home.php" id="homeLink">
                    <img src="../img/logo.png"  alt="">
                </a>
            </div>
            <div id="input-Search">
                <input type="search" name="search" id="inpSearch" class="inp" placeholder="search...">
                
            </div>
            <div id="Menu">
                <div id="Account">
                    <a href="<?= isset($ND_id) ? '../account/account.php' : '../login/login.php' ?>">
        ...
        <div id="banner">
            <img id="img-banner" src="../img/background-darksimple-bodybuilder-gymalhalla.png" alt="">
        </div>
    </section>
    ...
    <section id="mainSect">
        <main >
            ...
            <div id="divM">
                <h2 class="titleProd">Produtos</h2>

                <div id="grid">
                    <div class="divbox">
                        <img src="../img/cint1.webp" alt="" class="imgProd">
                        <div class="infoText">
                            <span>Cinturão Guts Berserk Branco <br> R$ 359,99</span>
                            <p>12x de R$ 29,99 sem juros</p>
                            <a href="">
                                comprar
                                <svg class="js-open-quickshop-icon icon-inline ml-1">
                                    <use xlink:href="#bag-small"></use>
                                </svg>
                            </a>
                    ...
                    <div class="divbox">
                        <img src="../img/cint2.webp" alt="" class="imgProd">
                        <div class="infoText">
                            <span>Cinturão Berserk Dark Night <br> R$ 149,88</span>
                            <p>12x de R$ 12,49 sem juros</p>
                                <a href="">
                                comprar
                                <svg class="js-open-quickshop-icon icon-inline ml-1">
                                    <use xlink:href="#bag-small"></use>
                    ...
                    <div class="divbox">
                        <img src="../img/cint3.webp" alt="" class="imgProd">
                        <div class="infoText">
                            <span>Cinturão Guts Berserk Preto <br> R$ 569,99</span>
                            <p>12x de R$ 47,49 sem juros</p>
                            <a href="">
                                comprar
                                <svg class="js-open-quickshop-icon icon-inline ml-1">
                                    <use xlink:href="#bag-small"></use>
                    ...
                    <div class="divbox">
                        <img src="../img/cint4.webp" alt="" class="imgProd">
                        <div class="infoText">
                            <span>Cinturão Vegeta DBS <br> R$ 359,99</span>
                            <p>12x de R$ 29,99 sem juros</p>
                            <a href="">
                                comprar
                                <svg class="js-open-quickshop-icon icon-inline ml-1">
    ...
    <!-- Informações das Camisas OverSizeds -->

    <section id="ThirdSect">
        <div id="Tshirt-infoMain">
            <div id="TextInfo-Tshirt">
                <div id="boxText-Tshirt">
                    <div id="titleTshirt">
                        <h3>CAMISAS OVERSIZED</h3>
                        <span>As Melhores São GYMVALHALLA</span>
                    </div>
                    <div id="SpansBox-Tshirt">
                        <span>Camisas Feitas 100% algodão</span> </br>
                        <br>
                        <span>Mangas a baixo do cotovelo, com barra reta</span> </br>
                        <br>
                        <span>Barra com tecido duplo</span>
                    </div>
                    
                </div>
                <div id="ButtonDiv-Tshirt">
                    <button>
                        <span>CONHEÇA NOSSAS CAMISAS </span>
                        <svg width="18" class height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 7.93994L15.5008 8.00006" stroke="url(#paint0_linear_203_1685)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M9.66406 1L16.6641 8L9.66406 15" stroke="url(#paint1_linear_203_1685)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            <defs>
                                <linearGradient id="paint0_linear_203_1685" x1="0.999006" y1="8.44253" x2="15.6945" y2="8.47158" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#B5191E"></stop><stop offset="1" stop-color="#910D11"></stop>
                                </linearGradient>
                                <linearGradient id="paint1_linear_203_1685" x1="9.66406" y1="8.03628" x2="16.758" y2="8.03628" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#B5191E"></stop>
                                    <stop offset="1" stop-color="#910D11"></stop>
                                </linearGradient>
                            </defs>
                        </svg>
                    </button>
            ...
            <div id="imgDetail-Tshirt">
                <div id="imgDiv-Tshirt">
                    <img src="../img/infoAtivo 3.png" alt="">
                </div>
            </div>
        </div>
    </section>

    <!-- Informações Sobre os Cintos -->

    <section id="CintSect-Info">
        <div id="Cint-Main">
            <div id="imgDatail-Cint">
                <div id="imgMain">
                    <img src="../img/infoCint/Cinto-De-Halterofilismo-para-Gin-sio-Fitness-Treinamento-De-For-a-Bench-Press-Cintura-Cintos-De.png" alt="">
                </div>
            </div>
            <div id="TextInfo-Cint">
                <div id="infoImg">
                    <div id="imgCint2">
                        <img src="../img/infoCint/Cinto-De-Halterofilismo-para-Gin-sio-Fitness-Treinamento-De-For-a-Bench-Press-Cintura-Cintos-De_1.png" alt="">
                    </div>
                    <div id="imgCint3">
                        <img src="../img/infoCint/Cinto-De-Halterofilismo-para-Gin-sio-Fitness-Treinamento-De-For-a-Bench-Press-Cintura-Cintos-De (1).png" alt="">
                    </div>
                </div>
                <div id="infoText">
                    <span>Coloque pressão sobre os músculos</span> </br>
                    <br>
                    <span>Ajuste o equilíbrio da força do exercício</span> </br>
                    <br>
                    <span>Fortaleça a força muscular</span>
                </div>
                <div id="btnCintLink">
                    <button>
                            <span>CONHEÇA NOSSOS CINTURÕES</span>
        ...
        <div id="MainPayDiv">
            <div id="PayFrete">
                <div class="d-inline-block icon-60px mb-3">
                    <svg class="icon-inline icon-4x align-item-middle svg-icon-text"><use xlink:href="#box-alt"></use></svg>
                </div>
                <div id="TextInfo-Frete">
                    <span class="PayText-Span">FRETE GRÁTIS PARA TODO BRASIL</span>
                    <p class="PayText-P">PARA COMPRAS A PARTIR DE R$ 300,00</p>
                </div>
            </div>
            <div id="PayParcel">
                <div class="d-inline-block icon-60px mb-3">
                    <svg class="icon-inline icon-4x align-item-middle svg-icon-text"><use xlink:href="#credit-card-alt"></use></svg>
                </div>
                <div id="TextInfo-Parcel">
                    <span class="PayText-Span">PARCELE EM ATÉ 12X</span>
                    <p class="PayText-P">SEM JUROS</p>
                </div>
            </div>
            <div id="PayContact">
                <div class="d-inline-block icon-60px mb-3">
                    <svg class="icon-inline icon-4x align-item-middle svg-icon-text"><use xlink:href="#whatsapp-line"></use></svg>
                </div>
                <div id="TextInfo-Contact">
                    <span class="PayText-Span">ENTRE EM CONTATO</span>
                    <p class="PayText-P">TIRE SUAS DUVIDAS</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="Newclothes">
        <div id="JustContainer">
            <h2 class="titleProd">NOVIDADES</h2>
            <div id="Grid-News">
                <div id="Row1" class="rows">
                    <div class="imgRow">
                        <img id="js-prod1" src="../img/Tshirts/TrueClub-Front.webp">
                    </div>
                    <div class="TextDivRow">
                        <span>CAMISETA LONG OVERSIZED - TRUE CLUB <br> R$ 149,00</span>
                        <p>12x de R$12,42 sem juros</p>
                        <a href="">
                            comprar
                            <svg class="js-open-quickshop-icon icon-inline ml-1">
                                <use xlink:href="#bag-small"></use>
                ...
                <div id="Row2" class="rows">
                    <div class="imgRow">
                        <img id="js-prod2" src="../img/Tshirts/CompanyOffWhite-Front.webp">
                    </div>
                    <div class="TextDivRow">
                        <span>CAMISETA LONG OVERSIZED - COMPANY OFF WHITE <br> R$ 149,00</span>
                        <p>12x de R$12,42 sem juros</p>
                        <a href="">
                            comprar
                            <svg class="js-open-quickshop-icon icon-inline ml-1">
                ...
                <div id="Row3" class="rows">
                    <div class="imgRow">
                        <img id="js-prod3" src="../img/Tshirts/LegendsGrey-Front.webp">
                    </div>
                    <div class="TextDivRow">
                        <span>CAMISETA LONG OVERSIZED - LEGENDS GREY <br> R$ 149,00</span>
                        <p>12x de R$12,42 sem juros</p>
                        <a href="">
                            comprar
                            <svg class="js-open-quickshop-icon icon-inline ml-1">
                ...
                <div id="Row4" class="rows">
                    <div class="imgRow">
                        <img id="js-prod4" src="../img/Tshirts/CompanyPurple-Front.webp">
                    </div>
                    <div class="TextDivRow">
                        <span>CAMISETA LONG OVERSIZED - COMPANY ROXA <br> R$ 149,00</span>
                        <p>12x de R$12,42 sem juros</p>
                        <a href="">
                            comprar
                            <svg class="js-open-quickshop-icon icon-inline ml-1">
                ...
                <div id="Row5" class="rows">
                    <div class="imgRow">
                        <img id="js-prod5" src="../img/Tshirts/shortsDropStar-Side1.webp">
                    </div>
                    <div class="TextDivRow">
                        <span>BERMUDA LARGE - DROP STAR <br> R$ 169,00</span>
                        <p>12x de R$12,42 sem juros</p>
                        <a href="">
                            comprar
                            <svg class="js-open-quickshop-icon icon-inline ml-1">
                ...
                <div id="Row6" class="rows">
                    <div class="imgRow">
                        <img id="js-prod6" src="../img/Tshirts/CoatOfArmsPink-Front.webp">
                    </div>
                    <div class="TextDivRow">
                        <span>CAMISETA LONG OVERSIZED - COAT OF ARMS PINK <br> R$ 149,00</span>
                        <p>12x de R$12,42 sem juros</p>
                        <a href="">
                            comprar
                            <svg class="js-open-quickshop-icon icon-inline ml-1">
            ...
            <h2 class="insta">
                <svg class="icon-inline mr-2 svg-icon-text">
                    <use xlink:href="#instagram"></use>
                </svg>
                GYMVALHALLA_OFICIAL
            </h2>
            <a class="instaLink" href="">Ver perfil</a>
        </div>
    </section>
    ...
    <section id="Newsletter">
        <div id="ContainerNewsletter">
            <div id="BoxNewsletter">
                ...
                <p>Cadastre-se e receba nossas ofertas.</p>
                <div id="InputEmail-NewsLetter">
                    ...
                    <input type="submit" name="contact" class="newsletter-btn" value="Enviar">
                </div>
            </div>
        </div>
    </section>
    ...
    <footer>
        ...
        <div id="information">
            <ul>
                ...
                <li><a href="">DNA GYMVALHALLA</a></li>
            </ul>
        </div>

        <div id="contatos">
            <ul>
                <li><a href="">+55 (47)992550850</a></li>
                <li><a href="">+55 (47)992550850</a></li>
                <li><a href="">gymvalhalla@gmail.com</a></li>
                <li><a href="">Av. Mendes Gonçalves, 1409, Gabriel</a></li>
            </ul>
        </div>
