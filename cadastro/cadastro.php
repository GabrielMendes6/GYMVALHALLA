...
<head>
    ...
    <title id="title">Criar Minha Conta | GYMVALHALLA</title>
</head>
<body>
    ...
    <section id="home-sect">
        ...
        <main>
            <div id="justCont">
                ...
                <form method="POST" action="cadastro.php" id="FormDiv">
                    <!-- Campo para o token CSRF -->
                    <input type="hidden" name="csrf_token" value="<?= isset($_SESSION['csrf_token']) ? $_SESSION['csrf_token'] : '' ?>">
                    
                    <!-- Campos de entrada para nome, email, telefone e senha -->
                    <div id="divName">
                        <label for="name" class="labelCad">Nome</label>
                        <input type="text" class="inputCad" name="name" id="name" placeholder="ex: Gabriel Mendes">
                    </div>

                    <div id="divEmail">
                        <label for="email" class="labelCad">E-mail</label>
                        <input type="email" class="inputCad" name="email" id="email" placeholder="ex: seuemail@email.com">
                    </div>

                    <div id="divTel">
                        <label for="tel" class="labelCad">Telefone</label>
                        <input type="tel" class="inputCad" name="tel" id="tel" placeholder="ex: 47992550850">
                    </div>

                    <div id="divPass">
                        <label for="pass" class="labelCad">Senha</label>
                        <div id="borderPass">
                                <input type="password" name="pass" id="pass" placeholder="ex: suasenha">
                                <button id="showPass">
                    ...
                    <div id="divPassC">
                        <label for="pass" class="labelCad">Confirmar Senha</label>
                        <div id="borderPassC">
                                <input type="password" name="passC" id="passC" placeholder="ex: suasenha">
                                <button id="showPassC">
                                <svg class="icon-inline">
                                        <use xlink:href="#eye-closed"></use>
                                </svg>
                    ...
                    <div id="envForm">
                    <input type="submit" id="eFormBtn" value="Cadastrar">
                    <span class="fontSmall">
                            Já possui uma conta? <a href="../login/login.php">Fazer Login</a>
                    </span>
                    </div>
                </form>
            </div>
