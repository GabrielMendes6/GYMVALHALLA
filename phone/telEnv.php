<?php
    ...
    if (isset($_SESSION["user_id"])) {
        ...
        if (isset($_POST['cod'])) {
            ...
            if ($userModel->validateTelWithCod($cod)) {
...
<svg xmlns="http://www.w3.org/2000/svg" class="hidden">    
    ...
    <section id="home-sect">
        ...
        <main>
            <div id="justCont" class="just">
                <form action="telEnv.php" method="POST">
                    <div id="textF">
                        <h2>Validar Novo Telefone</h2>
                    </div>
                    <div id="ContInput">
                        <div id="textInp">
                            <label for="cod">Insira o Codigo: </label>
                        </div>
                        <div id="boxInp" class="just">
                            <input type="text" name="cod" placeholder="Insira o codigo!" id="tel">
                        </div>
                        <div id="btnSub-div" class="just">
                            <input type="submit" id="sub" value="Verificar Codigo">
                        </div>
                    </div>
                </form>
            </div>
